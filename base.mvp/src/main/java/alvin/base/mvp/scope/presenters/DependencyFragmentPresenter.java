...
public class DependencyFragmentPresenter extends PresenterAdapter<ScopeContract.FragmentView>
    ...
    @Inject
    DependencyFragmentPresenter(@NonNull ScopeContract.FragmentView view,
